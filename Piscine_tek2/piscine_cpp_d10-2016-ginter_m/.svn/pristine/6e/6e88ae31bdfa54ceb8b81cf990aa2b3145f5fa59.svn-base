/*
** Character.cpp for ex01 in /home/fest/Epitech/Piscine_tek2/piscine_cpp_d10-2016-ginter_m/ex01
**
** Made by maxime ginters
** Login  <ginter_m@epitech.eu>
**
** Started on  Fri Jan 18 14:28:00 2013 maxime ginters
** Last update Fri Jan 18 14:28:00 2013 maxime ginters
*/
...
Character::Character(std::string const& name) :
    _weapon(NULL), _ap(40), _name(name)
{
}
