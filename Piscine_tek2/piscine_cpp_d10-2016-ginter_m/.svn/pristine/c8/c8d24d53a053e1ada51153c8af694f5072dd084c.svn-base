...
silent only
cd ~/Epitech/Piscine_tek2/piscine_cpp_d10-2016-ginter_m/ex00
...
exe 'vert 1resize ' . ((&columns * 114 + 58) / 117)
exe 'vert 2resize ' . ((&columns * 2 + 58) / 117)
argglobal
...
4
normal! 0
lcd ~/Epitech/Piscine_tek2/piscine_cpp_d10-2016-ginter_m/ex00
wincmd w
argglobal
edit ~/Epitech/Piscine_tek2/piscine_cpp_d10-2016-ginter_m/ex00/Victim.hh
nnoremap <buffer> <silent> - :CCTreeRecurseDepthMinus
nnoremap <buffer> <silent> = :CCTreeRecurseDepthPlus
setlocal keymap=
setlocal noarabic
