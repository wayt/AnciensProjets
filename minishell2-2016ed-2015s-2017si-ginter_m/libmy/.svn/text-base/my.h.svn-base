...
** Last update Fri Nov 30 19:32:05 2012 maxime ginters
*/
...
void	my_sort_int_tab(int *t, int size);
...
void	init_putnbr_base_tab(char *t);
...
extern t_printf_funct	my_printf_funct[];
