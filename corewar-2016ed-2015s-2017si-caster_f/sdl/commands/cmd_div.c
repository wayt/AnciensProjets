/*
** cmd_div.c for commands in /workspace/CoreWar/core/commands
**
** Made by maxime ginters
** Login  <ginter_m@epitech.eu>
**
** Started on  dim. déc. 16 18:10:36 2012 maxime ginters
** Last update dim. déc. 16 18:20:45 2012 maxime ginters
*/
...
int	get_div_reg(t_vm *vm, t_program *prog, int reg[3])
{
  int	i;
